...
export P_DYNAMIC_ISLAND_MUSIC_ENABLED=0
export P_DYNAMIC_ISLAND_APPSWITCH_ENABLED=0
export P_DYNAMIC_ISLAND_NOTIFICATION_ENABLED=0
export P_DYNAMIC_ISLAND_VOLUME_ENABLED=0
export P_DYNAMIC_ISLAND_BRIGHTNESS_ENABLED=0
export P_DYNAMIC_ISLAND_WIFI_ENABLED=0
export P_DYNAMIC_ISLAND_POWER_ENABLED=0
